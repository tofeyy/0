  ...
  "cells": [
    {
      ...
      "source": [
        "\n",
        "<h1>belethon session / سيشن بيليثون</h1>\n",
        "\n",
        "---\n",
        "\n",
        "![belethon session photo ](https://github.com/tofeyy/0/blob/main/blob/go/Picsart_25-01-15_02-35-06-656.jpg?raw=true)"
      ],
      "metadata": {
        "id": "LIOfiQxgQtIS"
      }
    },
    {
      ...
      "source": [
        ...
        "--- ---\n",
        "<h4>\n",
        "اداة تقوم باستخراج سيشن كود\n",
        "\n",
        "الخاص بتنصيب سورس جمثون باستعمال\n",
        "\n",
        "مكتبة\n",
        "\n",
        "```telethon & pyrogram```\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "---\n",
        "```الخطوة الاولى``` : تقوم باستخراج او استرجاع إيبي ايدي و إيبي هاش\n",
        "\n",
        "من الموقع الخاص\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "img = urllib.request.urlopen(\"https://github.com/tofeyy/0/blob/main/blob/go/Picsart_25-01-15_02-31-31-615.jpg?raw=true\"); imgg = np.asarray(bytearray(img.read()), dtype=np.uint8); image = cv2.imdecode(imgg, cv2.IMREAD_COLOR); cv2_imshow(image)\n",
        "\n",
        "if not os.path.exists(\"tgapp\"):\n",
        "    os.system(\"git clone -b tgapp https://github.com/tofeyy/0.git tgapp > log 2>1\")\n",
        "\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "from google.colab.patches import cv2_imshow\n",
        "\n",
        "img = urllib.request.urlopen(\"https://github.com/tofeyy/0/blob/main/blob/go/Picsart_25-01-15_02-35-06-656.jpg?raw=true\"); imgg = np.asarray(bytearray(img.read()), dtype=np.uint8); image = cv2.imdecode(imgg, cv2.IMREAD_COLOR); cv2_imshow(image)\n",
        "\n",
        "try:\n",
        "    session = session_ide_set.value\n",
        "    if session is None:\n",
        ...
        "    os.system(\"rm -rf 0\")\n",
        "    os.system(\"git clone -b telethon https://github.com/tofeyy/0.git > log 2>1\")\n",
        "    !python 0/main.py\n",
        "elif session == \"بايروجرام\" and os.path.exists(\"0/telethon\"):\n",
        "    os.system(\"rm -rf 0\")\n",
        "    os.system(\"git clone -b pyrogram https://github.com/tofeyy/0.git > log 2>1\")\n",
        "    !python 0/main.py\n",
